  ...
  const experts = [
    {
      ...
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/72abc51dd8c05389c504819085c58948dafee9ef?width=706",
      experience: [
    ...
    },
    {
      ...
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/1b089b3f5bd71555bd6468232d9b7bfc1a25a063?width=636",
      experience: [
      ...
      <div className="max-w-[1349px] mx-auto px-4 sm:px-6 lg:px-12">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg font-medium text-[#333] max-w-3xl mx-auto">
            Chúng tôi làm việc cùng các chuyên gia dày dặn kinh nghiệm trong
            ngành tài chính, đã thành công tư vấn và đồng hành cùng hàng ngàn
            người dùng
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto mb-8">
          {experts.map((expert, index) => (
            <div
              key={index}
              className="relative border border-[#E6E7E9] rounded-md overflow-hidden"
            >
              ...
              <div className="relative bg-white w-[65%] p-6 space-y-6">
                ...
                <div className="space-y-2">
                  <h4 className="text-[15px] font-semibold text-teal">
                    KINH NGHIỆM
                  </h4>
