        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8 lg:gap-12">
            <a
              ...
              className="text-[#656C86] text-sm lg:text-[15px] font-semibold hover:text-teal transition-colors"
            >
              Tư vấn Đầu tư
            </a>
            <a
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="group flex items-center gap-1 text-[#656C86] text-sm lg:text-[15px] font-semibold hover:text-teal transition-colors">
                  Giáo dục tài chính
                  <svg
                    width="9"
                    height="6"
