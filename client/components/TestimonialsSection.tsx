  ...
  const testimonials = [
    {
      ...
      quote: "Gia đình có một số khúc mắc, phân vân chưa biết nên mua nhà luôn chưa, sau buổi nói chuyện tư vấn riêng với Finful thì đã tự tin mua luôn rồi. Sổ đỏ trao tay rồi nhé, rất hài lòng về ngôi nhà đầu tiên của gia đình.",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/c101cc113c7fca035be2a8172909991bc255fe75?width=134"
    },
    {
      name: "Chị Thắm Bin",
      occupation: "Nhân viên văn phòng",
      title: "Mua nhà thành công sau buổi chia sẻ kiến thức",
      quote: "Chương trình chia sẻ rất hay, chị sẽ chia sẻ cho bạn bè cần nhé. Sau buổi gặp gỡ chia sẻ kiến thức thì chị cũng quyết định cọc mua nhà luôn.",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/6f0ec1fb7654b4a2f4d3f16d52c0214df062b601?width=134"
    }
  ];
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="flex justify-center items-center gap-4 mt-8">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M8 14L2 8L8 2" stroke="#00ACB8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M8 2L14 8L8 14" stroke="#00ACB8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
      </div>
