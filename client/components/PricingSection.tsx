  ...
  const packages = [
    {
      ...
      price: "399.000 đ",
      features: [
        { text: "1 buổi", highlight: true, description: "trải nghiệm tư vấn mua nhà 1:1 với chuyên gia" },
        { text: "Tài liệu phân tích tổng quan thị trường và các kênh đầu tư năm 2025 trị giá 5.000.000", highlight: false },
        { text: "Tài liệu phân thích về bản thân - yếu tố quyết định 90% thành công trong tích luỹ và chinh phục mục tiêu tài chính", highlight: false }
      ]
    },
    {
      icon: "https://api.builder.io/api/v1/image/assets/TEMP/eca7eab528a92559bc491907c3f5a6abf0ee00e3?width=74",
      ...
      price: "999.000 đ",
      features: [
        { text: "Lộ trình 3 buổi", highlight: true, description: "trải nghiệm tư vấn mua nhà 1:1 với chuyên gia" },
        { text: "Tài liệu phân tích tổng quan thị trường và các kênh đầu tư năm 2025 trị giá 5.000.000", highlight: false },
        { text: "Tài liệu phân thích về bản thân - yếu tố quyết định 90% thành công trong tích luỹ và chinh phục mục tiêu tài chính", highlight: false }
      ]
    }
                ...
                {pkg.features.map((feature, idx) => (
                  <div key={idx} className="flex gap-4 items-start">
                    ...
                    <p className="text-lg lg:text-[22px] text-[#1B223C] leading-relaxed">
                      {feature.highlight ? (
                        <>
                          <span className="font-bold text-teal">{feature.text}</span>
